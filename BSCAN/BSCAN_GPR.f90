...
INCLUDE "AUTO_READ_FILES_BSCAN.h"
...
DO Y = 1, TRA
      CALL fft_hilbert(STACKED_B_SCAN(1,Y,:), ROWS, HILBERT_STACKED_SIGNAL, HILBERT_STACKED_SIGNAL_imag)
...
INCLUDE "OUTPUT_A_SCOPE.h"                  !20,21,22,23
INCLUDE "OUTPUT_B_SCAN.h"                   !30,31,32,33 
!INCLUDE "OUTPUT_HILBERT_B_SCAN.h"          !34
INCLUDE "OUTPUT_HILBERT_STACKED_B_SCAN.h"   !35
