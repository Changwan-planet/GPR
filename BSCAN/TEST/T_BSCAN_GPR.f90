...
!DO X = 1, DIS, MV
   CALL mv_mean_bscan(B_SCAN_IMAGE4,MV,DIS,DIS2,ROWS,MV_MEAN)
!   MV_MEAN_BSCAN(,1,:) = MV_MEAN(1,1,:)
!END DO
...
!INCLUDE "OUTPUT_B_SCAN.h"                  !21 
!INCLUDE "OUTPUT_HILBERT_B_SCAN.h"          !22
!INCLUDE "OUTPUT_HILBERT_STACKED_B_SCAN.h"   !23
