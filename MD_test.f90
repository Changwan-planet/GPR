...
!FFT
imag = 0.0
    CALL fft(B_SCAN_IMAGE2(:,1), imag, ROWS, f_real, f_imag)
    CALL ifft(f_real, f_imag, ROWS, ifft_real, ifft_imag)


!    CALL dft(B_SCAN_IMAGE2(:,1), imag, ROWS, dft_real, dft_imag)
!    CALL idft(dft_real, dft_imag, ROWS, idft_real, idft_imag)


!HILBERT TRANSFORMATION
    CALL fft_hilbert(B_SCAN_IMAGE2(:,1),ROWS,HILBERT_SIGNAL)
!    CALL dft_hilbert(B_SCAN_IMAGE2(:,1),ROWS,HILBERT_SIGNAL)
!    CALL dft_hilbert(STACKED_A_SCOPE,ROWS,HILBERT_STACKED_SIGNAL)
