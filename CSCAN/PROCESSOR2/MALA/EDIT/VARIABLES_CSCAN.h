...
!INTEGER, PARAMETER :: DIS2  = 219        !I
!INTEGER, PARAMETER :: TRA2 = 58          !J
...
!INTEGER, PARAMETER :: DIS2  = 231        !I
!INTEGER, PARAMETER :: TRA2 = 92          !J
...
!INTEGER, PARAMETER :: DIS2  = 23        !I
!INTEGER, PARAMETER :: TRA2 = 51          !J
...
INTEGER, PARAMETER :: DIS2  = 200        !I
INTEGER, PARAMETER :: TRA2 = 140          !J
...
!===========================================================
REAL*8, DIMENSION(0:DIS, 0:TRA, 0:ROWS-1) ::  B_SCAN_IMAGE_H
REAL*8, DIMENSION(0:DIS, 0:TRA, 0:ROWS-1) ::  B_SCAN_IMAGE_H2
REAL*8, DIMENSION(0:DIS, 0:TRA, 0:ROWS-1) ::  B_SCAN_IMAGE_V
REAL*8, DIMENSION(0:DIS, 0:TRA, 0:ROWS-1) ::  B_SCAN_IMAGE_V2




REAL*8, DIMENSION(0:DIS, 0:TRA, 0:ROWS-1) ::  B_SCAN_IMAGE2
REAL*8, DIMENSION(0:DIS, 0:TRA, 0:ROWS-1) ::  B_SCAN_IMAGE3
REAL*8, DIMENSION(0:DIS, 0:TRA, 0:ROWS-1) ::  B_SCAN_IMAGE4


REAL*8, DIMENSION(0:DIS2, 0:TRA2, 0:ROWS-1) ::  B_SCAN_IMAGE5
...
INTEGER             :: XX, YY, ZZ
INTEGER             :: EDIT, EDIT2
REAL*8, DIMENSION(0:511)              :: TEMP
REAL*8, DIMENSION(0:511)              :: TEMP2
REAL*8, DIMENSION(0:511)              :: TEMP3
