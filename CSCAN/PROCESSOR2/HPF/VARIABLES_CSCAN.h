...
!============================================================
REAL*8, DIMENSION( DIS, TRA, ROWS) :: INST_A_SCOPE

!============================================================
REAL*8, DIMENSION( DIS,  TRA,  ROWS) :: MEAN_A_SCOPE
!============================================================
...
REAL*8, DIMENSION (DIS, TRA, 1:ROWS) :: dft_real
REAL*8, DIMENSION (DIS, TRA, 1:ROWS) :: dft_imag
REAL*8, DIMENSION (DIS, TRA, 1:ROWS) :: idft_real
REAL*8, DIMENSION (DIS, TRA, 1:ROWS) :: idft_imag
REAL*8, DIMENSION (DIS, TRA, 1:ROWS) :: a_idft_imag
!=============================================

!=====HILBERT TRANSFORM=====
REAL*8, DIMENSION (1, 1, 1:ROWS) :: HILBERT_SIGNAL
REAL*8, DIMENSION (DIS, TRA, 1:ROWS) :: HILBERT_B_SCAN
REAL*8, DIMENSION (DIS, TRA, 1:ROWS) :: HILBERT_power
REAL*8, DIMENSION (DIS, TRA, 1:ROWS) :: HILBERT_power2
REAL*8, DIMENSION (DIS, TRA, 1:ROWS) :: HILBERT_powerdB
!====================================================

!=====ATTRIBUTE ANALYSIS=====
REAL*8, DIMENSION (DIS, TRA, 1:ROWS) :: INST_PHASE
REAL*8, DIMENSION (DIS, TRA, 1:ROWS) :: INST_PHASE2
REAL*8, DIMENSION (DIS, TRA, 1:ROWS) :: INST_FREQUENCY
!====================================================
