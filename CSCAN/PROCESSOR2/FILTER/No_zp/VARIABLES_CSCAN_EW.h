...
INTEGER, PARAMETER :: ROWS3 = 1013      !Z 512
...
REAL*8, DIMENSION (DIS,TRA,ROWS3) :: power       
...
REAL*8              :: BGR
REAL*8              :: MEAN
REAL*8, DIMENSION(TRA, ROWS3) :: MEAN2
