...
!===============GSSI=================
INTEGER, PARAMETER :: LINE = 41       !X FOR STACKING
...
!===========================================================
REAL*8, DIMENSION(LINE,TRA,ROWS) ::  B_SCAN_IMAGE66
REAL*8, DIMENSION(LINE,TRA,ROWS) ::  B_SCAN_IMAGE6
REAL*8, DIMENSION(TRA,LINE,ROWS) ::  B_SCAN_IMAGE7
