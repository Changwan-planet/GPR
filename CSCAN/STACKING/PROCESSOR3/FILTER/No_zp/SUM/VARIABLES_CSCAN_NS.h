...
!NORTHERN MIHO
!INTEGER, PARAMETER :: DIS = 81        !X NUMBER OF POINT
!INTEGER, PARAMETER :: TRA = 7        !Y NUMBER OF TRACK
...
!2024MIHO
INTEGER, PARAMETER :: DIS = 73        !X NUMBER OF POINT
INTEGER, PARAMETER :: TRA = 41        !Y NUMBER OF TRACK
!INTEGER, PARAMETER :: DIS = 81        !X NUMBER OF POINT
!INTEGER, PARAMETER :: TRA = 4        !Y NUMBER OF TRACK
...
REAL*8, DIMENSION(DIS,1,ROWS) ::  B_SCAN_IMAGE3
