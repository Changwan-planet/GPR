...
!===============NS=================
INTEGER, PARAMETER :: LINE = 14           !THE NUMBER OF LINE
INTEGER, PARAMETER :: DIS = 20         !X !THE NUMBER OF STACK
INTEGER, PARAMETER :: TRA = 77        !Y !THE NUMBER OF STATIC POINT
