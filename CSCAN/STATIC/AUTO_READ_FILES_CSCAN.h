...
COMMON_PATH1 = "/home/changwan/GPR_DATA/KOREA/MIHO_ri/CSCAN/"
...
OUTPUT_NAME5= "BSCAN_GPR_rmavg.txt"                 !33
OUTPUT_NAME6= "3DCUBE_GPR_stacking.txt"              !40
OUTPUT_NAME7= "HILBERT_3DCUBE_stacking_powerdB.txt" !50


INPUT_PATH = TRIM(COMMON_PATH2)//ITEM_NUMBER
OUTPUT_PATH1 = TRIM(COMMON_PATH1)//OUTPUT_NAME1   !20
OUTPUT_PATH2 = TRIM(COMMON_PATH1)//OUTPUT_NAME2   !30
OUTPUT_PATH3 = TRIM(COMMON_PATH1)//OUTPUT_NAME3   !31
OUTPUT_PATH4 = TRIM(COMMON_PATH1)//OUTPUT_NAME4   !32
OUTPUT_PATH5 = TRIM(COMMON_PATH1)//OUTPUT_NAME5   !33
OUTPUT_PATH6 = TRIM(COMMON_PATH1)//OUTPUT_NAME6   !40
OUTPUT_PATH7 = TRIM(COMMON_PATH1)//OUTPUT_NAME7   !50
