...
!===========MALA-450MHz==================
!MIHO11
!INTEGER, PARAMETER :: DIS=1091      !X
!INTEGER, PARAMETER :: TRA=281       !Y
...
INTEGER, PARAMETER :: ROWS=627     !Z 


INTEGER, PARAMETER :: ROWS2=512     !Z 

INTEGER, PARAMETER :: DIS2= INT(DIS/10.0)
!INTEGER, PARAMETER :: DIS2= 99


!INTEGER, PARAMETER :: TRA2 = INT(TRA/10.0)
INTEGER, PARAMETER :: TRA2 = 99
...
INTEGER, DIMENSION(0:ROWS-1,0:DIS,0:TRA) :: B_SCAN_IMAGE          !MALA_450MHz, 160MHz
!============================================================


!=====MALA=====
REAL*8, DIMENSION(0:ROWS-1,0:DIS,0:TRA) :: B_SCAN_IMAGE2
REAL*8, DIMENSION(0:DIS,0:TRA,0:ROWS-1) :: B_SCAN_IMAGE3
REAL*8, DIMENSION(0:DIS,0:TRA,0:ROWS-1) :: B_SCAN_IMAGE3F
...
REAL*8, DIMENSION(DIS2) :: ROW_COR_DIS
INTEGER, DIMENSION(DIS2) :: ROW_COR_PIXEL

REAL*8, DIMENSION(DIS2) :: COL_COR_DIS
INTEGER, DIMENSION(DIS2) :: COL_COR_PIXEL
INTEGER, DIMENSION(DIS2) :: COL_COR_PIXEL2
