...
COMMON_PATH1="/home/changwan/GPR_DATA/KOREA/MIHO_ri/2022_BOMIN/Edit_data/Miho30/V/GPR/"
COMMON_PATH2="/home/changwan/GPR_DATA/KOREA/MIHO_ri/2022_BOMIN/Edit_data/Miho30/V/GNSS/"
...
OUTPUT_NAME40 = "3D_CSCAN_GPR_V.txt"    !40 

OUTPUT_NAME50 = "CSCAN_GNSS.txt"                 !50 
OUTPUT_NAME51 = "3D_CUBE_GPR_V_zp.txt"                  !51 
!OUTPUT_NAME51 = "CSCAN_GPR.raw"                  !51 
...
!+++++REVERSING THE EVEN_GPR TRACKS+++++++++++++++++++++++
     IF (MOD(G,2)/=0) THEN  !ODD  LINE
!     IF (MOD(G,2)==0) THEN   !EVEN LINE
...
!         DO P=1,DIS
         DO P =0, TRACE(G)-1
            B_SCAN_IMAGE2(:,G-1,(TRACE(G)-P+1)) = B_SCAN_IMAGE(:,G-1,P) 
         END DO      
