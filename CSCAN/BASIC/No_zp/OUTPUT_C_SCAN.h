...
!========3D CUBE-rmbpg-python==========================
DO X = 1, DIS
DO Y = 1, TRA
       WRITE(40,*) (B_SCAN_IMAGE4(X, Y, Z), Z = 1,ROWS)
       WRITE(41) (B_SCAN_IMAGE4(X, Y, Z), Z = 1,ROWS)
!       WRITE(40) (B_SCAN_IMAGE4(X, Y, Z), Z = 313,1,-1)
END DO 
END DO
...
!========3D CUBE-rmbpg-gnuplot==========================
 
!DO Z = 1, ROWS
!DO Y = 1, TRA
!       WRITE(40,*) (B_SCAN_IMAGE4(X, Y, Z), X = 1,DIS)
!END DO 
!END DO
...
!       WRITE(43) (B_SCAN_IMAGE6(X, Y, Z), Z = 1,ROWS3)
!END DO 
!END DO
