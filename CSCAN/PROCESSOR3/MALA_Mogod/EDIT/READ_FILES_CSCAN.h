...
!=============================PATH===================================
!MIHO_ri
COMMON_PATH1="/home/changwan/GPR_DATA/KOREA/MIHO_ri/2022_BOMIN/Edit_data/Miho30/CUBE/"
...
INPUT_NAME10 = "3D_CUBE_GPR_H_zp702.txt"          !10
!INPUT_NAME11 = "3D_CUBE_GPR_V_noflip.txt"          !11
INPUT_NAME11 = "3D_CUBE_GPR_V_zp702.txt"          !11
...
OUTPUT_NAME40 = "3D_CSCAN_GPR_EDIT.txt"                  !40 

OUTPUT_NAME50 = "3D_CUBE_GPR_EDIT.txt"                  !40 
...
DO R = 1, (DIS+1) * (TRA+1) * ROWS
   READ(10, *) XX, YY, ZZ, B_SCAN_IMAGE_H(XX,YY,ZZ)
END DO             

PRINT *, "COMPLETED TO READ GPR DATA-H"    


DO R = 1, (DIS+1) * (TRA+1) * ROWS
   READ(11, *) XX, YY, ZZ, B_SCAN_IMAGE_V(XX,YY,ZZ)
END DO             

PRINT *, "COMPLETED TO READ GPR DATA-V"    
