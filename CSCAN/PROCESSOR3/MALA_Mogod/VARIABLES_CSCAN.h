!===============MALA-MOGOD================
INTEGER, PARAMETER :: DIS=1563        !I
INTEGER, PARAMETER :: DIS2=1498        !I


INTEGER, PARAMETER :: TRA =110         !J
...
!===========================================================
REAL*8, DIMENSION(0:DIS-1, 0:TRA-1, 0:ROWS-1 ) :: B_SCAN_IMAGE
REAL*8, DIMENSION(0:DIS2-1, 0:TRA-1, 0:ROWS-1 ) :: B_SCAN_IMAGE2
REAL*8, DIMENSION(0:DIS2-1, 0:TRA-1, 0:ROWS-1) :: B_SCAN_IMAGE2_GC



!REAL*8, DIMENSION(DIS2,TRA,ROWS) :: B_SCAN_IMAGE7_E
!REAL*8, DIMENSION(DIS2,TRA,ROWS) :: B_SCAN_IMAGE8
!REAL*8, DIMENSION(DIS2,TRA,ROWS2) :: B_SCAN_IMAGE8_GC
!REAL*8, DIMENSION(DIS2,TRA,ROWS) :: B_SCAN_IMAGE9
!REAL*8, DIMENSION(DIS2,TRA,ROWS2):: B_SCAN_IMAGE9_GC
!============================================================

REAL*8, DIMENSION(1,1,0:ROWS-1) :: imag

!=====FAST FOURIER TRANSFORM===================
REAL*8, DIMENSION (0:DIS2-1,0:TRA-1,0:ROWS-1) :: f_real
REAL*8, DIMENSION (0:DIS2-1,0:TRA-1,0:ROWS-1) :: f_imag
REAL*8, DIMENSION (0:DIS2-1,0:TRA-1,0:ROWS-1) :: f_real2
REAL*8, DIMENSION (0:DIS2-1,0:TRA-1,0:ROWS-1) :: f_imag2
REAL*8, DIMENSION (0:DIS2-1,0:TRA-1,0:ROWS-1) :: ifft_real
REAL*8, DIMENSION (0:DIS2-1,0:TRA-1,0:ROWS-1) :: ifft_imag
!==============================================
...
REAL*8, DIMENSION (0:DIS2-1,0:TRA-1,0:ROWS-1) :: HILBERT_B_SCAN
REAL*8, DIMENSION (0:DIS2-1,0:TRA-1,0:ROWS-1) :: HILBERT_power
REAL*8, DIMENSION (0:DIS2-1,0:TRA-1,0:ROWS-1) :: HILBERT_powerlog

REAL*8, DIMENSION (0:DIS2-1,0:TRA-1,0:ROWS-1) :: HILBERT_power2

REAL*8, DIMENSION (0:DIS2-1,0:TRA-1,0:ROWS-1) :: HILBERT_powerdB
REAL*8, DIMENSION (0:DIS2-1,0:TRA-1,0:ROWS-1) :: HILBERT_powerdB2
!====================================================
