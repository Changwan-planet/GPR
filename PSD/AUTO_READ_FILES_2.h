...
!CHARACTER (LEN=13) :: FH1 = '211027_6__'
...
!=====AUTOMATIC CHANCE CODE FOR OPENING FILE===================
   ...
   IF(G<=9.AND.G>=1) THEN
     ...
     WRITE(FH1(N:N), FMT='(I1)') 0
     WRITE(FH1(N+1:N+1), FMT='(I1)') 0
     WRITE(FH1(N+2:N+2), FMT='(I1)') G
   
   ELSE IF(G<=99.AND.G>=10) THEN
    
     WRITE(FH1(N:N), FMT='(I1)') 0
     WRITE(FH1(N+1:N+2), FMT='(I2)') G
   
   ELSE

     WRITE(FH1(N:N+2), FMT='(I3)') G
   END IF
...
!COMMON_PATH1="/home/changwan/GPR/202110272/"
...
!COMMON_PATH1="/home/changwan/GPR/211027_6/"
!COMMON_PATH2="/home/changwan/GPR/211027_6/"
